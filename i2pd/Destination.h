...
namespace client
{
		...
		public std::enable_shared_from_this<LeaseSetDestination>
	{
		...
		public:
			...
			virtual std::shared_ptr<const i2p::data::LeaseSet> FindLeaseSet (const i2p::data::IdentHash& ident);
			bool RequestDestination (const i2p::data::IdentHash& dest, RequestComplete requestComplete = nullptr);
			void CancelDestinationRequest (const i2p::data::IdentHash& dest, bool notify = true);	

			// implements GarlicDestination
			std::shared_ptr<const i2p::data::LocalLeaseSet> GetLeaseSet ();
			virtual std::shared_ptr<i2p::tunnel::TunnelPool> GetTunnelPool () const { return m_Pool; }
    ...
    virtual void RequestLeaseSet (const i2p::data::IdentHash& dest, RequestComplete requestComplete);

    virtual void StartTunnelPool();
